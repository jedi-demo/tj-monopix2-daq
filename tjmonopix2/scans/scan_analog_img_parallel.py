...
class AnalogScan(ScanBase):
    scan_id = 'analog_scan'
    is_parallel_scan = True  # Parallel readout of ExtTrigger-type scans etc.; must be overridden in the derived classes if needed
    ...
    def _configure(self, start_column=0, stop_column=512, start_row=0, stop_row=512, **_):
        ...
        self.chip.masks.set_text_mask("TJMonopix\n pixlab\n IFIC", "/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf", 70)
        self.chip.masks.update(force=True)


        self.chip.registers["IBIAS"].write(250) # JPI delete this !
